...
const Hero = () => {
  ...
  return (
    <div className='px-2 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      <div className='text-center mb-6'>
        ...
        max-sm:text-xs text-gray-600'>Tranform your content creation with our suite of premium of Ai tools.
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        <button className='bg-white px-10 oy-3 rounded-lg-border
